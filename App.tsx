...
import { ViewState, UserRole, User, Post, JobListing, EventListing } from './types';
...
// Helper hook for localStorage persistence REMOVED
// MOCK DATA REMOVED (moved to server)

import { fetchPosts, fetchJobs, fetchEvents } from './services/api';
      ...
      <aside className={`fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-slate-200 transform transition-transform duration-300 ease-in-out md:relative md:translate-x-0 ${mobileMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="p-6">
          ...
          <div className="space-y-2">
            ...
            <NavItem view={ViewState.AI_MENTOR} icon={Sparkles} label="AI Career Mentor" />
        ...
        <div className="p-4 md:p-8 max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="flex-1 min-w-0">
              ...
              {currentView === ViewState.AI_MENTOR && (
