...
import { Users, Activity, Search, School, GraduationCap, MessageSquare, LogOut } from 'lucide-react';
import { fetchAdminStudents, fetchAdminActivities, fetchAdminAlumni } from '../services/api';

export const AdminDashboard = ({ currentUser, onNavigate, onChat, onLogout }) => {
