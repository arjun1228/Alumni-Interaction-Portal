...
export const Profile: React.FC<ProfileProps> = ({ user, onUpdateUser, onNavigate, readOnly = false }) => {
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
           ...
           <div className="bg-indigo-600 rounded-xl p-6 text-white shadow-lg shadow-indigo-200">
              ...
              {!readOnly && (
              <button 
                 onClick={() => onNavigate && onNavigate(ViewState.MESSAGES)}
